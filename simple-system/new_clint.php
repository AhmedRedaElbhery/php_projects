...
<body>
    ...
    <div class="container mt-5 p-5">
        ...
        <form id="userForm" >
                ...
                <button class="btn btn-primary ml-5 mt-4 py-2" type="submit">submit</button>
                <a class="btn btn-dark py-2 mt-4" href="home.php">Cancel </a>
            </form>
...
<script>
    document.getElementById("userForm").addEventListener("submit", function(event) { 
        ...
        this.action = 'clint_database.php?name=' + name + '&email' + email;
    });
