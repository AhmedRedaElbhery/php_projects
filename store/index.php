...
<body>
    ...
    <?php if ($stat !== "true"): ?>
        <div class="p-2 d-flex justify-content-start mb-3">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-2 mt-3 mr-2 ml-2">
                ...
                <h4 class="bg-primary text-light p-2 mt-4"> Categories</h4>
            ...
            <div id="p1" class="col-lg-9">
                <?php while($row = mysqli_fetch_assoc($result)): ?>
                    <div>
                        ...
                        <div>
                            <?php if($stat == true):?>
                            <a href="addtocart.php?userid=<?php echo $id ?>&id=<?php echo $row['id'] ?>" class="btn btn-primary">Add To Cart </a>
                            <?php endif; ?>

                            <?php if($stat != true):?>
                            <a href="login.php" class="btn btn-primary">Add To Cart </a>
                            <?php endif; ?>
                            <a href="viewmore.php?category=<?php echo $row['category']?>" class="btn btn-dark">View More </a>
                        </div>
